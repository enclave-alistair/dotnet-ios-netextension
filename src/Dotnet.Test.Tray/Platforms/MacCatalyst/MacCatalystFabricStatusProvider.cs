...
namespace Dotnet.Test.Tray.Platforms.MacCatalyst;

public class MacCatalystFabricStatusProvider : IFabricStatusProvider
{
    ...
    public MacCatalystFabricStatusProvider()
    {
